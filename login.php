...
<style>
  ...
  transition: background-color 2s; /* Change the duration as needed */
}
...
<div id="box" >
 ...
 <td><input type="text" name="kAdi" maxlength="11"
class="form-control" placeholder="Kullanıcı Adınızı Giriniz"></td>
 </tr>
 <tr>
 <td>Şifreniz:</td>
...
value="Giriş için tıklayınız"
style="width:450px;color:white;" class="btn btn-outline-primary"></td>
 </tr> 
 </table>
 </form>
</div>
